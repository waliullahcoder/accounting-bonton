    ...
    <div class="brand">
        <a href="{{ Route('admin.dashboard') }}" class="brand-logo w-100">
            <img class="lazyload logo-big"
                data-src="{{ file_exists(@$admin_setting->logo) ? asset(@$admin_setting->logo) : asset('backend/images/logo/logo.png') }}"
                height="62" width="100%" alt="Logo" style="object-fit: contain;">
            <img class="lazyload logo-sm"
                data-src="{{ file_exists(@$admin_setting->favicon) ? asset(@$admin_setting->favicon) : asset('backend/images/logo/favicon.png') }}"
                height="62" width="100%" alt="Logo" style="object-fit: contain;">
        </a>
    </div>
    <!-- End Brand Area -->
