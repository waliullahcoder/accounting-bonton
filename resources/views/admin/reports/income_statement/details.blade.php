    ...
    <div class="card">
        <div class="card-header pe-2 py-2">
            <div class="d-flex align-items-center justify-content-between gap-2">
                ...
                <form method="get" action="{{ Route('admin.income-statement-head-details.index') }}">
                    <input type="hidden" name="coa_setup_id" value="{{ request('coa_setup_id') }}">
                    <input type="hidden" name="start_date" value="{{ request('start_date') }}">
                    <input type="hidden" name="end_date" value="{{ request('end_date') }}">
                    <a href="{{ Route('admin.income-statement.index') }}" class="btn btn-sm btn-primary">Go Back</a>
