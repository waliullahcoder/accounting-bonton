...
@section('form')
    ...
    <div class="row g-3">
        ...
        <div class="col-sm-4">
            <label for="coa_head_code" class="form-label"><b>Voucher Account <span class="text-danger">*</span></b></label>
            <select name="coa_head_code" id="coa_head_code" class="form-select select" data-placeholder="Select Account"
                required>
                <option value=""></option> 
                @foreach ($coas as $item)
                    <option value="{{ $item->head_code }}"
                        {{ $item->head_code == request('coa_head_code') ? 'selected' : '' }}>
