                ...
                <form action="{{ Route('admin.change-images', $admin->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="profile-header">
                        ...
                        <img class="lazyload img-fit absolute-full"
                            data-src="{{ file_exists($admin->cover_image) ? asset($admin->cover_image) : asset('backend/images/avatar/default/cover.png') }}"
                            alt="Cover Image">
                    ...
                    <div class="profile-meta w-fit mx-auto">
                        <img class="user-img img-fit lazyload"
                            data-src="{{ file_exists($admin->image) ? asset($admin->image) : asset('backend/images/avatar/default/profile.jpg') }}"
                            alt="vendor image">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-4 col-xs-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <button type="button"
                                                class="input-group-text password-toggler text-primary"><i
