...
@section('content')
    <div class="row g-3">
        <div class="col-lg-4 col-sm-6">
            ...
            <select name="debit_head" id="debit_head" class="form-select select" data-placeholder="select Account Name" required>
                        ...
                        <tr>
                            ...
                            <td class="py-1">
                                <input type="number" step="any" class="totalCredit text-end border-transparent"
                                    id="totalCredit" name="totalCredit" value="{{ $creditEntries->sum('credit_amount') }}"
                                    readonly>
                            </td>
                            <th class="py-1"></th>
                        </tr>
    ...
    <script type="text/javascript">
            ...
            $(document).on('click', '#add_item', function(e) {
                ...
                if (head_id == '') {
                    Swal.fire({
                        ...
                        toast: true,
                        position: 'top-right',
                        text: "Please select a credit head!",
                        icon: "error",
                ...
                $('#credit_heads').trigger("chosen:updated");
            });
        ...
        function findTotal() {
            ...
            $(".credit").each(function(index, value) {
                ...
                var credit_head = $('.head_name')[index];
                var head_name = $(credit_head).text();
