                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                <div class="custom-control custom-checkbox d-flex gap-2">
                                    ...
                                    <label class="form-label custom-control-label c-pointer" for="checkAll"><b class="ps-2">Check
                                            All</b></label>
                                </div>
                            </div>
                                                                                                                ...
                                                                                                                <div
                                                                                                                    ...
                                                                                                                    <div
                                                                                                                        ...
                                                                                                                        @foreach ($subchild->actions as $key => $action)
                                                                                                                            @if (Auth::user()->hasRole('System Admin') && str_contains($action->route, '.destroy'))
                                                                                                                                @continue
                                                                                                                            @endif
                                                                                                                                ...
                                                                                                                                <div
                                                                                                                                    ...
                                                                                                                                    <div
                                                                                                                                        ...
                                                                                                                                        <label
                                                                                                                                            ...
                                                                                                                                            class="custom-control-label c-pointer"><span class="ms-2">{{ $action->name }}</span></label>
                                                                                                                                    </div>
                                                                                                                                </div>
                                                                                                                            @endif
                                                                                                                        @endforeach
